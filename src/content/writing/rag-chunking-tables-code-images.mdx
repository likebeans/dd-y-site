...
titleEn: "Protecting Tables, Code Blocks, and Images in RAG Chunking"
description: "在复杂文档处理中保护语义结构，而不是简单按长度切分。"
descriptionEn: "Preserve semantic structure in complex document processing instead of splitting by length alone."
...
sectionsEn:
  ...
  - heading: "A More Reliable Direction"
    body:
  ...
  - heading: "Evaluation Matters More Than Parameters"
    body:
